...
export default function PrivacyPolicyPage() {
  ...
  useSEO({
    ...
    description: 'Read our privacy policy to understand how Hey Alberta collects, uses, and protects your personal information.',
  });
  ...
  useEffect(() => {
    ...
    siteAPI
      ...
      .then((res) => {
        if (!cancelled) {
          setContent(res.data?.privacyPolicyContent || '');
        }
      })
      .catch(() => {
        if (!cancelled) {
