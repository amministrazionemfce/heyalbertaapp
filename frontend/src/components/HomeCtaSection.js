        ...
        <div className="mx-auto max-w-3xl rounded-3xl border border-slate-200/90 bg-white p-8 text-center shadow-xl shadow-slate-200/40 ring-1 ring-slate-100 md:p-12 md:px-14">
          ...
          <div className="mt-10 flex flex-col items-stretch gap-4 sm:flex-row sm:justify-center sm:gap-5">
            <Button
              ...
              className="h-12 rounded-xl px-8 text-base font-semibold shadow-md transition bg-purple-700 hover:bg-purple-800 text-white hover:shadow-lg"
            ...
            <Link to={ROUTES.ABOUT} className="sm:inline-flex">
              <Button
                variant="outline"
                className="h-12 w-full rounded-xl border-2 border-slate-200 bg-white px-8 text-base font-semibold text-slate-800 shadow-sm transition hover:border-purple-300 hover:bg-purple-50 hover:text-purple-900 sm:w-auto"
